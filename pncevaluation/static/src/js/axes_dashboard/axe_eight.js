odoo.define('pncevaluation.axe_eight', function(require) {
    "use strict";
        ...
        do_search: function(domains, contexts, group_bys) {
            ...
            return $.when(this.has_been_loaded).then(function() {
                return self.dataset.read_slice(fields, {
                    ...
                    self.rpc("/pncevaluation/get_dashboard_stats", { numero_axe: 8 }).done(function(result) {
                        $('.o_control_panel').attr('style', 'display:none');
                        $(container).empty();
    ...
    core.view_registry.add('axe_eight', MyView);
