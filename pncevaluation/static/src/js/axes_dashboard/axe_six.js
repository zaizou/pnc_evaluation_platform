odoo.define('pncevaluation.axe_six', function(require) {
    "use strict";
        ...
        do_search: function(domains, contexts, group_bys) {
            ...
            return $.when(this.has_been_loaded).then(function() {
                return self.dataset.read_slice(fields, {
                    ...
                    self.rpc("/pncevaluation/get_dashboard_stats", { numero_axe: 6 }).done(function(result) {
                        $(container).empty();
    ...
    core.view_registry.add('axe_six', MyView);
