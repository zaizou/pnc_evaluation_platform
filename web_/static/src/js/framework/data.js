odoo.define('web.data', function(require) {
    ...
    var Query = Class.extend({
        ...
        _execute: function(options) {
            ...
            return session.rpc('/web/dataset/search_read', {
                ...
                domain: pyeval.eval('domains', [this._model.domain(this._filter)]),
    ...
    var QueryGroup = Class.extend({
        init: function(model, grouping_fields, read_group_group) {
            ...
            var fixed_group = _.extend({ __context: { group_by: [] }, __domain: [] },
                read_group_group);
    ...
    var DataSet = Class.extend(mixins.PropertiesMixin, {
        ...
        read_ids: function(ids, fields, options) {
            ...
            return this._model.call(method, [ids_arg, fields || false], { context: context })
        ...
        default_get: function(fields, options) {
            options = options || {};
            return this._model.call('default_get', [fields], { context: this.get_context(options.context) });
        },
        /**
