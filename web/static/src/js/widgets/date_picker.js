odoo.define('web.datepicker', function(require) {
    ...
    var DateWidget = Widget.extend({
        ...
        init: function(parent, options) {
            ...
            console.log(l10n.date_format);
            if (this.type_of_date === 'datetime')
                date_format = time.strftime_to_moment_format((l10n.date_format + ' ' + l10n.time_format));
            else
                date_format = time.strftime_to_moment_format(l10n.date_format);
